        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <p className="text-slate-300 text-sm leading-relaxed mt-4">
              Developing people. Strengthening organizations. For over 30 years, ICG has delivered human capital solutions across government, healthcare, education, and the private sector.
            </p>
            <div className="flex gap-4">
              <a className="w-10 h-10 rounded-lg bg-slate-800 flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-all" href="https://www.linkedin.com/in/le-angela-ingram/" target="_blank" rel="noopener noreferrer">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-slate-300">
              <li className="flex items-start gap-2">
                ...
                <span>4938 Hampden Lane #302<br />Bethesda, MD 20814</span>
              </li>
              <li className="flex items-center gap-2">
                <span className="material-symbols-outlined text-primary text-lg">call</span>
                <a href="tel:+12026436011" className="hover:text-primary transition-colors">(202) 643-6011</a>
              </li>
              <li className="flex items-center gap-2">
                <span className="material-symbols-outlined text-primary text-lg">mail</span>
                <a href="mailto:leangela@consultingram.com" className="hover:text-primary transition-colors">leangela@consultingram.com</a>
              </li>
            </ul>
          </div>
        </div>
